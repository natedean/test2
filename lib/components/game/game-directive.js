  ...
  var directive = {
    ...
    <div class="gtGameContainer">
      <div class="gtGameContainer__questionTextContainer">
        <div class="gtGameContainer__questionText" ng-if="!vm.correctState">{{ vm.question.question }}</div>
            <div class="gtGameContainer__correctAnswerTextContainer" ng-if="vm.correctState">
              <div class="gtGameContainer__correctAnswerText">Correct!</div>
              <div class="gtGameContainer__bonusText">{{ 'Speed bonus: ' + vm.speedTimerBonus }}</div>
              <div class="gtGameContainer__bonusText">{{ 'Multi-category bonus: ' + vm.categoryBonus }}</div>
            </div>
