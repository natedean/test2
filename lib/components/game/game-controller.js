...
GameController.$inject = ['QuestionFactory', 'UserFactory', 'GameModelFactory', '$interval', '$timeout'];

function GameController(QuestionFactory, UserFactory, GameModelFactory, $interval, $timeout){
  let vm = this;
  ...
  function resetGameState(){
    GameModelFactory.setActiveState(true);
    vm.correctState = false;
